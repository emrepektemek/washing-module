...
@Component({
  ...
  templateUrl: './order-pant-list-for-washing.component.html',
  styleUrl: './order-pant-list-for-washing.component.css',
})
export class OrderPantListForWashingComponent implements OnInit {
